...
describe("useNetwork", () => {
  ...
  describe("network switching", () => {
    it("should update when network changes", () => {
      // Start with testnet wrapper
      const TestnetWrapper = createWrapper("testnet");
      const { result, rerender } = renderHook(
        () => useNetwork(),
      ...
      // Create new wrapper with mainnet and rerender
      const MainnetWrapper = createWrapper("mainnet");
      rerender({ wrapper: MainnetWrapper } as any);
